...
@my_decorator  # passing my_function to my_decorator
def my_function():  # replaced by function_that_runs_f
...
def decorator_arguments(number):
    def my_decorator(f):
        ...
        def function_that_runs_f(*args, **kwargs):
            print("Hello!")
            if number == 56:  # checks if parameter is 56
                print("Not running!")
            else:
                f(*args, **kwargs)
            print("After")
