...
# print(my_set_variable[0])  # This won't work, because there is no order.
# Which one is element 0?

my_list_variable.append('another string')
print(my_list_variable)

# my_tuple_variable.append('a string')  # This won't work, because a tuple is
# not a list.
